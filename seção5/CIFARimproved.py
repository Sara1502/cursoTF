...
batch_size = 32
data_generator = tf.keras.preprocessing.image.ImageDataGenerator(with_shift_ange=0.1, height_shift_range=0.1, horizontal_flip=True)
train_generator = data_generator.flow(x_train, y_train, batch_size)
step_per_epoch = x_train.shape[0] // batch_size
r = model.fit_generator(train_generator, validation_data=(x_test, y_test), step_per_epoch=step_per_epoch, epochs=50)
